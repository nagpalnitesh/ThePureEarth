...
client = razorpay.Client(
    auth=('rzp_live_VRjjFEPaZRzwY0', 'Nbdl6PbUjnEli7wkuzipk6Nb'))
...
def create_order(request):
    ...
    return render(request, 'payment/created.html', {'order_id': order_id, 'public_key': 'rzp_live_VRjjFEPaZRzwY0', 'amount': amount_inr, 'amountorig': amount})
